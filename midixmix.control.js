...
/* ----------------------- ENCODER ---------------------- */
const KNOBS = {
    "30": { mode: 'send', send: 1, chan: 0 },
    "31": { mode: 'send', send: 1, chan: 1 },
    "32": { mode: 'send', send: 1, chan: 2 },
    "33": { mode: 'send', send: 1, chan: 3 },
    "34": { mode: 'send', send: 1, chan: 4 },
    "35": { mode: 'send', send: 1, chan: 5 },
    "36": { mode: 'send', send: 1, chan: 6 },
    "37": { mode: 'send', send: 1, chan: 7 },
    "38": { mode: 'send', send: 0, chan: 0 },
    "39": { mode: 'send', send: 0, chan: 1 },
    "40": { mode: 'send', send: 0, chan: 2 },
    "41": { mode: 'send', send: 0, chan: 3 },
    "42": { mode: 'send', send: 0, chan: 4 },
    "43": { mode: 'send', send: 0, chan: 5 },
    "44": { mode: 'send', send: 0, chan: 6 },
    "45": { mode: 'send', send: 0, chan: 7 },
    "46": { mode: 'pan', chan: 0 },
    "47": { mode: 'pan', chan: 1 },
    "48": { mode: 'pan', chan: 2 },
    "49": { mode: 'pan', chan: 3 },
